 ...
 */
public class RadialGradientDetailsPane extends BorderPane {
    ...
    public ObjectPropertyElement FocusAngle = new ObjectPropertyElement("Angle", 0, 360, 45);
    public ObjectPropertyElement FocusDistance = new ObjectPropertyElement("Distance", 0, 100, 0);
    public ObjectPropertyElement Radius = new ObjectPropertyElement("Radius", 0, 200, 50);
    public ObjectPropertyElement CenterX = new ObjectPropertyElement("Center X", 0, 100, 50);
    public ObjectPropertyElement CenterY = new ObjectPropertyElement("Center Y", 0, 100, 50);
    
    private Stage _stage = null;
    
    public RadialGradientDetailsPane(Stage stage) {
        this._stage = stage;
        ...
        GridPane gradientPropertyPane = new GridPane();
        gradientPropertyPane.add(this.FocusAngle, 0, 0);
        gradientPropertyPane.add(this.FocusDistance, 0, 1);
        gradientPropertyPane.add(this.Radius, 0, 2);
        gradientPropertyPane.add(this.CenterX, 1, 0);
        gradientPropertyPane.add(this.CenterY, 1, 1);
        
        topToolBar.getItems().addAll(
                new Separator(),
                gradientPropertyPane
        );
        ...
        this.PreviewRectangle.setStroke(RadialGradientStop.MOUSE_EXIT_COLOR);
        ...
        ((RadialGradientStop) this.StopsBasePane.getChildren().get(1)).SetSelect();
        ...
        this.AddStopButton.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                ...
                ((RadialGradientStop) StopsBasePane.getChildren().get(StopsBasePane.getChildren().size() - 1)).SetSelect();
            }
        });
                ...
                if (Stops.size() > 2) {
                    ...
                    for (Node node : StopsBasePane.getChildren()) {
                        if (node instanceof RadialGradientStop) {
                            RadialGradientStop currentStop = (RadialGradientStop) node;
        ...
        this.ReverseButton.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                ...
                ((RadialGradientStop) StopsBasePane.getChildren().get(0)).SetSelect();
            }
        });
        ...
        this.GradientColorChooser.ColorProperty.addListener(new ChangeListener<Color>() {
            ...
            public void changed(ObservableValue<? extends Color> observable, Color oldValue, Color choosenColor) {
                for (Node node : StopsBasePane.getChildren()) {
                    if (node instanceof RadialGradientStop) {
                        RadialGradientStop currentGradientStopButton = (RadialGradientStop) node;
        ...
        this.SaveAsSvgButton.setOnAction(new EventHandler<ActionEvent>() {
            ...
            @Override
            public void handle(ActionEvent event) {
                WriteToSvgFromRadialGradient(fileChooser);
            }
        });
        ...
        this.FocusAngle.PropertySlider.valueProperty().addListener(new ChangeListener<Number>() {
            @Override
        ...
        this.FocusDistance.PropertySlider.valueProperty().addListener(new ChangeListener<Number>() {
            @Override
            public void changed(ObservableValue<? extends Number> observable, Number oldValue, Number newValue) {
                UpdateGradient();
            }
        ...
        this.Radius.PropertySlider.valueProperty().addListener(new ChangeListener<Number>() {
            @Override
            public void changed(ObservableValue<? extends Number> observable, Number oldValue, Number newValue) {
                UpdateGradient();
            }
        ...
        this.CenterX.PropertySlider.valueProperty().addListener(new ChangeListener<Number>() {
            @Override
            public void changed(ObservableValue<? extends Number> observable, Number oldValue, Number newValue) {
                UpdateGradient();
            }
        ...
        this.CenterY.PropertySlider.valueProperty().addListener(new ChangeListener<Number>() {
            @Override
            public void changed(ObservableValue<? extends Number> observable, Number oldValue, Number newValue) {
                UpdateGradient();
            }
    ...
    public void UpdateGradient() {
        ...
        double focusAngle = this.FocusAngle.GetValue();
        double focusDistance = this.FocusDistance.GetValue() / 100.0;
        double radius = this.Radius.GetValue() / 100.0;
        double centerX = this.CenterX.GetValue() / 100.0;
        double centerY = this.CenterY.GetValue() / 100.0;
        
        boolean proportional = true;
        CycleMethod cycleMethod = CycleMethod.NO_CYCLE;

        RadialGradient mainGradient = new RadialGradient(focusAngle, focusDistance, centerX, centerY, radius, proportional, cycleMethod, this.Stops);
    ...
    public void DeselectAllGradientStops() {
        for (Node node : StopsBasePane.getChildren()) {
            if (node instanceof RadialGradientStop) {
                ((RadialGradientStop) node).SetDeselect();
            }
        }
    }
    ...
    public void ExportToCss(FileChooser fileChooser) {
        double radius = this.Radius.GetValue() * (GRADIENT_OUTPUT_SIZE / 100.0);
        double centerX = this.CenterX.GetValue();
        double centerY = this.CenterY.GetValue();
        double focusX = (this.FocusDistance.GetValue() * Math.cos(this.FocusAngle.GetValue() - 45) + centerX);
        double focusY = (this.FocusDistance.GetValue() * Math.sin(this.FocusAngle.GetValue() - 45) + centerY);
        
        String css = "background: radial-gradient(" + radius + "px circle at " + centerX + "% " + centerY + "%";
        
        for (Stop stop : this.Stops) {
            String colorAsHex = this.GetHexColorString(stop.getColor());
            String offset = Double.toString(stop.getOffset() * 100);
            
            css += ", " + colorAsHex + " " + offset + "%";
        }
        
        css += ");";
        
        css = GetUniqueId(".radialGradient") + " {\n\t" + css + "background: " + css + "\n}";
        
        ExportToText("css", "Cascanding Style Sheets", fileChooser, css);
    }
    
    public void WriteToSvgFromRadialGradient(FileChooser fileChooser) {
        String format = "svg";
        String description = "Scalable Vector Graphics";
        String svg = GetSvgFromRadialGradient();
    ...
    public String GetSvgFromRadialGradient() {
        String svgContent = "";
        
        double radius = this.Radius.GetValue();
        double centerX = this.CenterX.GetValue() * (GRADIENT_OUTPUT_SIZE / 100.0);
        double centerY = this.CenterY.GetValue() * (GRADIENT_OUTPUT_SIZE / 100.0);
        double focusX = (this.FocusDistance.GetValue() * (GRADIENT_OUTPUT_SIZE / 100.0) * Math.cos(this.FocusAngle.GetValue() - 45) + centerX);
        double focusY = (this.FocusDistance.GetValue() * (GRADIENT_OUTPUT_SIZE / 100.0) * Math.sin(this.FocusAngle.GetValue()) - 45) + centerY;
        
        String linearGradientId = GetUniqueId("linearGradient");
        String radialGradientId = GetUniqueId("radialGradient");
        
        svgContent += "<svg width=\"" + GRADIENT_OUTPUT_SIZE +"\" height=\"" + GRADIENT_OUTPUT_SIZE + "\" xmlns=\"http://www.w3.org/2000/svg\" xmlns:xlink=\"http://www.w3.org/1999/xlink\"><defs><linearGradient id=\"" + linearGradientId + "\">";
        
        for (Stop stop : this.Stops) {
            String colorAsHex = this.GetHexColorString(stop.getColor());
            String offset = Double.toString(stop.getOffset());
            
            svgContent += "<stop stop-color=\"" + colorAsHex + "\" stop-opacity=\"1\" offset=\"" + offset + "\" />";
        }
        
        svgContent += "</linearGradient><radialGradient gradientUnits=\"userSpaceOnUse\" r=\"" + radius + "\" fy=\"" + focusY + "\" fx=\"" + focusX + "\" cy=\"" + centerY + "\" cx=\"" + centerX + "\" id=\"" + radialGradientId + "\" xlink:href=\"" + linearGradientId + "\" /></defs><g><rect fill=\"url(#" + radialGradientId + ")\" y=\"0\" x=\"0\" height=\"" + GRADIENT_OUTPUT_SIZE + "\" width=\"" + GRADIENT_OUTPUT_SIZE + "\" id=\"" + GetUniqueId("rect") + "\"/></g></svg>";
